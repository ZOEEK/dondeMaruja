        ...
        <div class="container">
         <div class="row" style="margin:100px 0px;">
          ...
          <div class="s8 center">
           ...
           <p class="right"><b>Cupón ${numeroCupon}</b></p>
           <br>
           <br>
             <p class="col s5 offset-s1">Fecha de emisión: ${fechaEmision}</p> 
             <p class="col s5 offset-s1">Fecha de Validez: ${fechaValidez}</p>

             <p>Cliente:</p>
              
             <h3><b>${nombreApellidos}</b></h3>  

            <p>Rut: ${rut}<p>

            <p>Dirección: ${direccion}  Correo ${mail}
                Fono: ${numeroTelefono}</p>

            <p>DESCUENTO: Aplicar un 15% de descuento al total de su compra del ${fechaValidez}</p>
